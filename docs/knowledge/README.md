...
Seed of the project's future RAG knowledge base. Every research session writes its
durable findings here so agents (and the Phase 2 retrieval graph) can recall them
instead of re-researching. Files are English for token efficiency; the teacher-facing
project story lives in the root [README.md](../../README.md) (Azerbaijani).
